...
/**
 * AES-128-GCM encryption/decryption utility.
 * @description Encrypts and decrypts payloads using AES-GCM with 128-bit key.
 */
export class AES128GCM {
  /** AES-GCM implementation with 128-bit key */
  readonly #impl = new AESGCM(16)
